...
urlpatterns = [
    ...
    url(r'^semi-finisheditem/search/$', search_semi_finished_item_view, name='search_semi_finished_item'),
    ...
    url(r'^finishedproduct/search/$', search_finished_product_view, name='search finished product'),
]